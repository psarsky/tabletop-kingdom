...
function Banner(): JSX.Element {
	...
	return (
		<BannerContainer>
			...
			<BannerContent>
				<BannerTitle variant="h2">Talisman: Magic and Sword - 5th Edition!</BannerTitle>
				<BannerDescription variant="subtitle1">
					The legendary board game is back with updated mechanics and stunning artwork!
					Perfect for seasoned players and newcomers alike. Grab your copy today and start
					your adventure!
				</BannerDescription>
			</BannerContent>
		</BannerContainer>
